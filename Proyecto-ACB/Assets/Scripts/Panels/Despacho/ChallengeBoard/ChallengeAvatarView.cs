...
/// <summary>
/// Controla la vista del avatar en el tablón de desafios
/// </summary>
public class ChallengeAvatarView : PlayerView
{
    #region Fields and Properties

    private ChallengeAcceptedData.AvatarChallengeData challengeFieldData; //Datos del avatar
    ...
    public void SetAvatarView(ChallengeAcceptedData.AvatarChallengeData challengeFieldData)
    {
