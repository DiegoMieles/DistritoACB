...
public class PlayerChallengeView : PlayerView
{
    ...
    private Action onFinishLoadingAvatar; //Acción que se ejecuta al finalizar la carga del avatar
    ...
    /// <param name="onFinishLoadingAvatar">Acción que se ejecuta al finalizar la carga del avatar</param>
